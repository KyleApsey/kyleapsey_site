    ...
    return {
      projects: [
        ...
        },
        {
          ...
          tech: ['PHP','Laravel','WordPress','SCSS']
        },
        {
          slug: 'knox',
          ...
          tech: ['JavaScript','CSS Animations','Accessibility']
        },
        {
          slug: 'boca',
          ...
          tech: ['Vue.js','Nuxt.js','WCAG 2.1 AA','Performance']
        },
        {
          slug: 'kap-site',
          ...
          tech: ['Legacy Systems','JavaScript','SCSS']
        }
      ]
    };
  }
